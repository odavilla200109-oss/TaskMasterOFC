  ...
  return (
    <div style={{minHeight:"100vh",background:"var(--bg-card)",padding:"60px 20px",fontFamily:"'Inter',sans-serif"}}>
      <div style={{maxWidth:720,margin:"0 auto"}}>
        ...
        <h1 style={{fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:900,fontSize:36,color:"var(--text-main)",marginBottom:6}}>Política de Privacidade</h1>
        ...
        {[
          ...
          <div key={t} style={{marginBottom:28}}>
            <h2 style={{fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:700,fontSize:18,color:"var(--text-main)",marginBottom:8}}>{t}</h2>
